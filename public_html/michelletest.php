...
<body>
    <nav class="navbar">
        <div class="navbar__container">
            <a href="/" id="navbar__logo"><img style="width:100px;height:100px" pglr-uri="file:///Users/ClaireLi/Desktop/logo.png" /></a>SWAP
            ...
            <ul class="navbar__menu">
                <li class="navbar__item">
                    ...
                    <img src="icons/home.png" style="filter: contrast(160%) invert(100%); width: 40px;">
                    </a>
                </li>
                <li class="navbar__item">
                    <a href="/art.php" class="navbar__links">
                    <img src="icons/art.png" style="filter: contrast(160%) invert(100%); width: 30px;">
                    </a>
                </li>
                <li class="navbar__item">
                    <a href="/wurtle.php" class="navbar__links">
                    <img src="icons/wurtle.webp" style="filter: contrast(160%) invert(100%); width: 30px;">
                    </a>
                </li>
                <li class="navbar__item">
                    <a href="/personalitytest.php" class="navbar__links" style="font-size: 30px;">
                    P
                    </a>
                </li>
                <li class="navbar__item">
                    <a href="/search.php" class="navbar__links">
                    <img src="icons/search.png" style="filter: contrast(160%) invert(100%); width: 30px;">
                    </a> 
                </li>                
                <li class="navbar__item">
                    <a href="/profile.php?username=<?=$user?>" class="navbar__links">
                    <img src="icons/person.png" style="filter: contrast(160%) invert(100%); width: 30px;">
                    </a> 
                </li>                
    ...
    if ($showTimeline == false) {
        echo '<center><h1>Not Logged In</h1></center><br>';
        ...
        echo '<div style="position: fixed; bottom: 0px;">
            Created by Alex (@tapok) and Claire (@claire)
            </div>';
    } else {
        $user_id = Login::isLoggedIn();
