    ...
    <nav class="navbar">
        <div class="navbar__container">
            ...
            <ul class="navbar__menu">
                ...
                <li class="navbar__item">
                    <a href="/testfile.php" class="navbar__links">
                    Wurtle
                    </a>
                </li>
                <li class="navbar__item">
        ...
        <div>
            ...
            <div class="popup" id="popup-1">
                ...
                <div class="content">
                    ...
                    <h1 style="vertical-align: top;">STATISTICS</h1>
                    <?php 
                    if ($showTimeline) {
            ...
            <form action="testfile.php" method="post" id="allInputs">
                ...
                <input class="line6" style="width:80px; height:80px; font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()">
                <input class="line6" style="width:80px; height:80px; font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()">
                <input disabled="true" class="line6" style="width:80px; height:80px; font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()"><div style="padding-bottom: 5px;"></div>
                ...
                <script>
                        ...
                        if (event.keyCode === 13) { // enter
                            ...
                            if (!isValid && word != guess.toLowerCase()) {
                                ...
                                $(document).ready(function(){
                                    $("#allInputs :input").prop("disabled", true);
                                });
                                } else if (row > 6) {
                                    alert("You lost");
                    ...
                    function updateStats(win, attempts, time) {
                        ...
                        request.open("POST", "https://swap0nline.com/testfile.php");
