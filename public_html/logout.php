...
if (isset($_POST['confirm'])) {
    ...
    //setcookie("SID", $token, time() + 60*60*24*7, '/', "", 0);
    //setcookie("SID_", '1', time() + 60*60*24*3, '/', "", 0);
...
<body>
    ...
    <div class="div__box" style="height: 220px;">
    <center><br></r><h1 style="color:#9c09d1;">Logout</h1><br>
