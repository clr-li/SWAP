    ...
    <nav class="navbar">
        <div class="navbar__container">
            ...
            <ul class="navbar__menu">
                ...
                <li class="navbar__item">
                    <a href="/alextest.php" class="navbar__links">
                    Wurtle
                    </a>
                </li>
                <li class="navbar__item">
...
?>
    ...
    <center>
        <div>
                ...
                <div class="content">
                    ...
                    if ($showTimeline) {
                        ...
                        if ($games == 0) {
                            ...
                            $winRate = round($wins / $games, 1) * 100;
                        }
                        if ($games != 1) {
                            echo $games." games";
                        } else {
                    ...
                    ?>
                    <?php if ($showTimeline) : ?> <!--only show chart if user is logged in-->
                    <div style="width: 100%; height: 188px; overflow: hidden; display: inline-block;">
            ...
            <form action="alextest.php" method="post">
                <input disabled="true" class="line1" style="text-align: center; caret-color: transparent; margin: 0; width:min(10vw,10vh); height:min(10vw,10vh); font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()"><!--
                --><input disabled="true" class="line1" style="text-align: center; caret-color: transparent; margin: 0; width:min(10vw,10vh); height:min(10vw,10vh); font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()"><!--
                --><input disabled="true" class="line1" style="text-align: center; caret-color: transparent; margin: 0; width:min(10vw,10vh); height:min(10vw,10vh); font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()"><!--
                --><input disabled="true" class="line1" style="text-align: center; caret-color: transparent; margin: 0; width:min(10vw,10vh); height:min(10vw,10vh); font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()"><!--
                --><input disabled="true" class="line1" style="text-align: center; caret-color: transparent; margin: 0; width:min(10vw,10vh); height:min(10vw,10vh); font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()"><!--
                --><div style="padding: 0; margin: 0"></div><!--
                --><input disabled="true" class="line2" style="text-align: center; caret-color: transparent; margin: 0; width:min(10vw,10vh); height:min(10vw,10vh); font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()"><!--
                --><input disabled="true" class="line2" style="text-align: center; caret-color: transparent; margin: 0; width:min(10vw,10vh); height:min(10vw,10vh); font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()"><!--
                --><input disabled="true" class="line2" style="text-align: center; caret-color: transparent; margin: 0; width:min(10vw,10vh); height:min(10vw,10vh); font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()"><!--
                --><input disabled="true" class="line2" style="text-align: center; caret-color: transparent; margin: 0; width:min(10vw,10vh); height:min(10vw,10vh); font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()"><!--
                --><input disabled="true" class="line2" style="text-align: center; caret-color: transparent; margin: 0; width:min(10vw,10vh); height:min(10vw,10vh); font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()"><!--
                --><div style="padding: 0; margin: 0"></div><!--
                --><input disabled="true" class="line3" style="text-align: center; caret-color: transparent; margin: 0; width:min(10vw,10vh); height:min(10vw,10vh); font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()"><!--
                --><input disabled="true" class="line3" style="text-align: center; caret-color: transparent; margin: 0; width:min(10vw,10vh); height:min(10vw,10vh); font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()"><!--
                --><input disabled="true" class="line3" style="text-align: center; caret-color: transparent; margin: 0; width:min(10vw,10vh); height:min(10vw,10vh); font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()"><!--
                --><input disabled="true" class="line3" style="text-align: center; caret-color: transparent; margin: 0; width:min(10vw,10vh); height:min(10vw,10vh); font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()"><!--
                --><input disabled="true" class="line3" style="text-align: center; caret-color: transparent; margin: 0; width:min(10vw,10vh); height:min(10vw,10vh); font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()"><!--
                --><div style="padding: 0; margin: 0"></div><!--
                --><input disabled="true" class="line4" style="text-align: center; caret-color: transparent; margin: 0; width:min(10vw,10vh); height:min(10vw,10vh); font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()"><!--
                --><input disabled="true" class="line4" style="text-align: center; caret-color: transparent; margin: 0; width:min(10vw,10vh); height:min(10vw,10vh); font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()"><!--
                --><input disabled="true" class="line4" style="text-align: center; caret-color: transparent; margin: 0; width:min(10vw,10vh); height:min(10vw,10vh); font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()"><!--
                --><input disabled="true" class="line4" style="text-align: center; caret-color: transparent; margin: 0; width:min(10vw,10vh); height:min(10vw,10vh); font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()"><!--
                --><input disabled="true" class="line4" style="text-align: center; caret-color: transparent; margin: 0; width:min(10vw,10vh); height:min(10vw,10vh); font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()"><!--
                --><div style="padding: 0; margin: 0"></div><!--
                --><input disabled="true" class="line5" style="text-align: center; caret-color: transparent; margin: 0; width:min(10vw,10vh); height:min(10vw,10vh); font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()"><!--
                --><input disabled="true" class="line5" style="text-align: center; caret-color: transparent; margin: 0; width:min(10vw,10vh); height:min(10vw,10vh); font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()"><!--
                --><input disabled="true" class="line5" style="text-align: center; caret-color: transparent; margin: 0; width:min(10vw,10vh); height:min(10vw,10vh); font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()"><!--
                --><input disabled="true" class="line5" style="text-align: center; caret-color: transparent; margin: 0; width:min(10vw,10vh); height:min(10vw,10vh); font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()"><!--
                --><input disabled="true" class="line5" style="text-align: center; caret-color: transparent; margin: 0; width:min(10vw,10vh); height:min(10vw,10vh); font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()"><!--
                --><div style="padding: 0; margin: 0"></div><!--
                --><input disabled="true" class="line6" style="text-align: center; caret-color: transparent; margin: 0; width:min(10vw,10vh); height:min(10vw,10vh); font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()"><!--
                --><input disabled="true" class="line6" style="text-align: center; caret-color: transparent; margin: 0; width:min(10vw,10vh); height:min(10vw,10vh); font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()"><!--
                --><input disabled="true" class="line6" style="text-align: center; caret-color: transparent; margin: 0; width:min(10vw,10vh); height:min(10vw,10vh); font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()"><!--
                --><input disabled="true" class="line6" style="text-align: center; caret-color: transparent; margin: 0; width:min(10vw,10vh); height:min(10vw,10vh); font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()"><!--
                --><input disabled="true" class="line6" style="text-align: center; caret-color: transparent; margin: 0; width:min(10vw,10vh); height:min(10vw,10vh); font-size: 3em; text-transform: uppercase;" maxlength="1" onmousedown="prevent()"><div style="padding-bottom: 5px;"></div>
                ...
                <script>
                    ...
                    let blank = false;
                    let stl = "text-align: center; margin: 0; width:min(10vw,10vh); height:min(10vw,10vh); font-size: 3em; text-transform: uppercase;";
                    let gameOver = false;
                    console.log(word);
                            ...
                            if (!isValid && word != guess.toLowerCase()) {
                                ...
                                for (let i = 0; i < 5; i++) {
                                    ...
                                    if (letters[i] == inputs[i].value.toLowerCase()) {
                                        ...
                                        inputs[i].style = stl + "background-color: green;";
                                    } else if (temp.includes(inputs[i].value.toLowerCase())) {
                                        let j = temp.indexOf(inputs[i].value.toLowerCase());
                                        temp = temp.slice(0, j) + temp.slice(j+1); // remove the matched character so it doesn't get matched multiple times if there's only one occurence of it
                                        inputs[i].style = stl + "background-color: #5A1F13;";
                                    } else {
                                        inputs[i].style = stl + "background-color: grey;";
                                    }
                                }
                                row++;
                                ix=0;
                    ...
                    function updateStats(win, attempts, time) {
                        ...
                        request.open("POST", "https://swap0nline.com/alextest.php");
                    ...
                    <?php if ($showTimeline) : ?> // only create chart if user is logged in
                    ...
                    var chart = new CanvasJS.Chart("chartContainer", {
                    	...
                    	axisY2:{
                    	    interval: 1,
                    		interlacedColor: "rgba(120, 45, 224,.2)",
                    		gridColor: "rgba(120, 45, 224,.1)",
                    		title: "Games"
                    	},
                    	data: [{
                    		type: "bar",
                    		...
                    		dataPoints: [
                    		    <?php 
                    		    $attemptings = DB::query('SELECT attempt1, attempt2, attempt3, attempt4, attempt5, attempt6, losses FROM wurtle WHERE user_id=:user_id', array(':user_id'=>$user_id))[0];
                    		    $ordinals = Array("First", "Second", "Third", "Fourth", "Fifth", "Sixth", "Never");
                    		    for ($x = 0; $x <= 6; $x++) {
                    		        $attempting = $attemptings[$x];
                    		        echo '{ y: ' . strval($attempting) . ', label: "' . $ordinals[$x] . '" },';
                    		    }
                    		    ?>
                    // 			{ y: 0, label: "First" },
                    // 			{ y: 0, label: "Second" },
